...
def destination_id_callback(call: CallbackQuery) -> None:
    """
    Пользователь нажал на кнопку города, который ему нужен. Записываем id этого города и переходим к следующему шагу.
    Запрашиваем количество отелей для вывода в чат.
    :param call: Нажатая кнопка с выбором города
    :return: None
    """
    ...
    if call.data:
        ...
        bot.send_message(call.message.chat.id, "Сколько вывести отелей в чат(Не более 10)?")